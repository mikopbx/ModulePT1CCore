...
return [
    ...
    'module_pt1c_core_WebinarLinkRussian' => 'Webinar για τη ρύθμιση της ενότητας',
    'module_pt1c_core_WikiDocsRussian' => 'Τεκμηρίωση Wiki για τη ρύθμιση της ενότητας',
    'module_pt1c_coreUpdateStatus' => 'Ενημέρωση κατάστασης',
    'module_pt1c_coreDisconnected' => 'Η μονάδα απενεργοποιήθηκε',
    'module_pt1c_coreConnected' => 'Η μονάδα είναι συνδεδεμένη',
    'SubHeaderModulePT1CCore' => 'Ενότητα διαχείρισης κλήσεων από υπολογιστή',
